...
In order to test these hypotheses, we used morphometric outline analysis. With this technique exact outlines of artifacts can be overlaid and compared making variations between artifacts readily apparent. Our assemblage consisted of photographs of mata’a (n=401) taken by Lipo on Rapa Nui from 2007 through 2009.  25 to 33 artifacts were randomly selected from each of (4) sites. 
