...
While the range of variability in shape shown in Figure 4 is significant, using simply metrics of length and width (Figure 5) shows that there appears to be just a single distribution of these object without clear modes. 
