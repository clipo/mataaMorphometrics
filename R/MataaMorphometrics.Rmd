...
The *mata'a* of Rapa Nui share some similarity with stone tools found on other islands across the Pacific.  On New Britain in Melanesia, for example, Torrence (-@Torrence@2009aa, -@Torrence@2009ab, -@Torrence@2013aa) has described obsidian stemmed tools that share much in common with the shape of *mata'a.* Torrence (see also @Kononenko:2012aa) argues that these tools may have been used for range of activities including tatooing.  Pitcairn Island is remote Eastern Polynesian island that   is located ca. 1900 km to the west of Rapa Nui. The island was inhabited by historically related Polynesian populations, though abandoned during prehistory.  An additional but limited comparison can be made for Pitcairn Island, where a few stemmed lithic tools have been found (@Heyerdahl:1965aa). 

As a comparison for our study, we generated outlines of examples stemmed lithic tools from published images and drawings of these islands using the same procedure for Rapa Nui. While the sample sizes of the non-Rapa Nui assemblages are small, when we compare the shapes of *mata'a* with those other objects, we find that the Pitcairn Island stemmed artifacts have overall shapes that are quite distinct. While we cannot rule out the possibility that the Pitcairn examples are a few extremely long and pointed shapes that happen to have been collected from a much wider array of variability, these shapes are certainly more consistent with hafted tools for hunting or weapons.  The New Britain artifacts, on the other hand,  wide array of features that are more like the ones from Rapa Nui. It is certainly conceivable that one of Rapa Nui *mata'a* reflect the same kinds of uses that are thought to characterize the New Britain tools. Tatooing is known from Rapa Nui through ethnohistoric observation (@Huish:1839aa, p. 77;@Metraux:1940aa; @Thomson:1891aa, p. 22) and as markings on the prehistoric *moai* (@Lee:1992aa). It would not be surprising that at least some of the mata'a objects were used in tatooing practices, though their numbers and widespread distribution makes it implausible that they were all used in this fashion. 
...
When we take a careful look at the shape of mata'a we simply do not see evidence that these class of artifacts wereJust dont find evidence of weaponry - nothing falls out that points to some subset of the objects being distinctive -- all the intermediate shapes. So no performance to blade shape -- no constraints. Simply make them to have an edge and a stem. 
