...
xCenter = 800/scalingFactor  # x coordinate of centroid (if its fixed, otherwise can be aligned based on average centroid, etc.)
yCenter = 900/scalingFactor # y coordinate of centroid
...
![Figure 6.  Variability in mata’a shape. Magenta outlines are maximum and minimum outlines within the assemblage. The green outline is the mean. The blue and red outlines are two standard deviations above and below the mean respectively.](../Figures/Figure6.png)
...
```
Figure 7. *Mata'a* shape variability. The outlines of the 
