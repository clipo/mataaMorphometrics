...
RapaNui$coo <- lapply(RapaNui$coo, coo.interpolate, 3600)
RapaNuirr.int <- coo.samplerr(RapaNui, 120) # and plot this one
radar.plot(RapaNuirr.int) ; title("interpolated")
```
Figure 6.  Variability in *mata’a* shape shown with 95% confidence intervals.
