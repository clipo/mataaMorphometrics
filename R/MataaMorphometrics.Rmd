...
Just dont find evidence of weaponry - nothing falls out that points to some subset of the objects being distinctive -- all the intermediate shapes. So no performance to blade shape -- no constraints. Simply make them to have an edge and a stem. 
