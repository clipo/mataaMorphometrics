...
plot(lengthFrame$number, lengthFrame$mean,  type = "l", xlab="Sample Size (N)", ylab="Length (cm)")
...
plot(widthFrame$number, widthFrame$mean,  type = "l", xlab="Sample Size (N)", ylab="Width (cm)")
