...
The *mata'a* of Rapa Nui share some similarity with stone tools found on other islands across the Pacific.  On New Britain in Melanesia, for example, Torrence (-@Torrence@2009aa, -@Torrence@2009ab, -@Torrence@2013aa) has described obsidian stemmed tools that share much in common with the shape of *mata'a.* Torrence (see also @Kononenko:2012aa) that these tools may have been used for range of activities including tatooing. On Pitcairn Island located 1900 km to the west of Rapa Nui and inhabited by historically related populations, a few stemmed lithic tools have been found (@Heyerdahl:1965aa). 

In our study, we generated outlines of stemmed lithic tools from published images and drawings in the same way we generated outlines for the Rapa Nui *mata'a*. While the sample sizes of the non-Rapa Nui artifacts are small, when we compare the shapes of *mata'a* with those other objects, we find that the Pitcairn Island stemmed artifacts have overall shapes that are quite distinct.  The New Britain artifacts that are thought to represent an array of non-lethal function are more like the ones from Rapa Nui.
