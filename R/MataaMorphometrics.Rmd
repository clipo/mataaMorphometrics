...
```{r width_metrics, message=FALSE, echo=FALSE, warning=FALSE, fig.width=4,fig.height=4}
...
As a comparison for our study, we generated outlines of examples stemmed lithic tools from published images and drawings of these islands using the same procedure for Rapa Nui. With this expanded set of shapes, the elliptic Fourier analysis required 13 harmonics to adequate characterize the outlines (Figure 14).
